...
**למה:** נבחר דאטה-סט של תיאורי מוצרים כדי לאפשר חיפוש טבעי של מוצרים לפי תיאור (למשל "נעליים נוחות לריצה") ולא רק לפי שם.
**שאלות מצופות:**
מאחר וזה פסקאות עם עובדות רנדומליות, מצופה שלאה כלשהי של המשתמש בנושא מסויים. למשל (על בסיס הפסקאו שהוכנסו, שימו לב שהמונחים אינם זהים לתוכן הכתוב בפיסקה, למשל ראשי תיבות או מילים דומות, ואכן מחוזרת פיסקה 
...
ומאחר והחיפש הוא על בסיס התאמה סמנטית, זה שעוי להירות כמו רשימה של דברים שצריך או מותר לעשות, והם יוחזרו למשתמש ככאלה. אסטרטגיות נפוצות הן: חלוקה לפי כמות פסקאות (עשוייה להיות בעייתית במקרה בו פסקה קודמת
...
## 4. הסבר כללי:
קוראים את הדאטה סט (כ-200 שורות ראשונות על מנת לעמוד במגבלת הגודל. לא הצלחתי למצוא דאטה סטים שהם גם קטנים מספים וגם לא דורשים ניקוי אז לקחתי אחד מעט גדול יותר והשתמשתי בשורות הראשונות. ) 
